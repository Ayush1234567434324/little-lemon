import littlelemon from '../../assests/Asset 16@4x.png'
import lillittlelemon from '../../assests/Asset 9@4x.png'
...
export const CodeIcon = (props) => {
  ...
  return (
    <img 
      src={isSmallScreen ? lillittlelemon : littlelemon} 
      alt='Little lemon restaurant' 
      width={`${isSmallScreen?"40px":"200px"}`}
    />
  );
};
